...
var write = document.getElementById("start");
...
var unsortedArray = [5, 2, 4, 1, 3,];
for(i = 0; i < unsortedArray.length; i++) {
  write.innerHTML += unsortedArray[i] + " ";
}

function switchNumbers(unsortedArray,firstCheck,secondCheck) {
